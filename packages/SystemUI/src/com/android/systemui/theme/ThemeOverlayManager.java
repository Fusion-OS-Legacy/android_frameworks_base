...
class ThemeOverlayManager {
    ...
    @VisibleForTesting
    static final String OVERLAY_CATEGORY_GESTURE = "android.theme.customization.gesture_style";
    @VisibleForTesting
    ...
    ThemeOverlayManager(OverlayManager overlayManager, Executor executor,
        ...
        mTargetPackageToCategories.put(ANDROID_PACKAGE, Sets.newHashSet(
                OVERLAY_CATEGORY_COLOR, OVERLAY_CATEGORY_GESTURE, OVERLAY_CATEGORY_FONT,
        ...
        mCategoryToTargetPackage.put(OVERLAY_CATEGORY_GESTURE, ANDROID_PACKAGE);
